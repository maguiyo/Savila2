...
$query = "SELECT * FROM articulos where nombre like '%".$filtro_nombre."%' ORDER BY nombre ASC";
$queEmp = mysql_query($query, $conexion);
?>
<html>
<head>
<script type="text/javascript" src="js/script.js"></script>
<title>Listado de Art&iacuteculos</title>
</head>
<body>
<div align="center" class="articulo">  

Buscar Art&iacuteculos
<form method="post" action="index.php?p=consulta_articulos">
    <strong>Nombre</strong>
	<input type="hidden" name="p" value ="consulta_articulos" />
...
<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
	<thead>
   <tr>
    <th class="asc"><h3>Nombre </h3>  </td>
    <th class="head"><h3>Precio </h3> </td>
	<th class="head"><h3>Descripcion </h3> </td>
    <th class="head"><h3>Promocion </h3> </td>
	<th class="head"><h3>Activo </h3> </td>
  </tr> <tr></tr>
   </thead>
   <tbody>
  ...
  <tr>
    ...
    <td class=""><?php echo $result['precio']; ?></td>
	<td class=""><?php echo $result['descripcion']; ?></td>
	<?php
	 $variable=intval($result['promocion']); 
	 if($variable==1){
	 ?>
	 ...
	 <?php } ?> 
	<?php
	 $variabledos=intval($result['activo']); 
	 if($variabledos==1){
	 ?>
	 <td class=""><img alt="Imagen" src="img/iconcheck.png" /></td>
	 <?php }else{ ?> 
    ...
    <td><a href="index.php?p=editar_articulo.php&nombre=<?php echo $result['nombre']; ?>">Editar</a></td>
  </tr>
  <?php } ?>
   </tbody>
</table>
