<?php
	...
	$sql="INSERT INTO CONTACTOS (nombre,direccion,telefono,celular,activo) VALUES ('$_POST[nombre]','$_POST[direccion]','$_POST[telefono]','$_POST[celular]','1')";
	?>
...
.add_insert{width:468px;height:60px;float:left;border:0px solid red;margin-left: 492px;margin-top: -42px;}
	...
	<h4>Se ha creado satisfactoriamente el contacto. </h4>
	
	<a href="index.php?p=consulta_contactos">Volver a Lista Contactos</a></td>
	</div>
	<?php
