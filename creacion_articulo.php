...
<?php 
	...
	if($_SESSION["rol"] == "") {
	echo"<script>alert('Su usuario no tiene permiso de Operador para cargar esta pagina, por favor logeese de nuevo');
...
<html>
	<head>
		<title>
			Creaci&oacute;n Art&iacuteculos
		</title>
...
<br>
     ...
     <div align="center" class="contacto">   
      <p align="center">Creaci&oacute;n Art&iacuteculos</p>  
	      
		<form action ='index.php?p=ingreso_articulo.php' method='POST'>
		<input type="hidden" name="p" value ="consulta_articulos" />
         <p align="center"> Nombre: </p> 
		<input type = 'text' name='nombre' size='40'> <br>
         <p align="center"> Precio: </p> 
		<input type = 'text' name='precio' size='40'> <br>
         <p align="center">  Descripci&oacute;n  </p> 
		<input type = 'text' name='descripcion' size='40'> <br>
		<input type = 'submit' value='Crear Articulo' > <br>
		</form>
		<br><br>
		<a href = 'consulta_articulos.php'> Consulta  </a>
        </div>
		</div> 
	</body>
	</html>