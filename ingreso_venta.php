<?php
	...
	if (isset($nombre_c1) and $TipoRegistro1 == 1 and $ConfirmacionBoton1 == 1)
   ...
   ?>
	...
	if (isset($nombre_c2) and $TipoRegistro2 == 1 and $ConfirmacionBoton2 == 1)
	{$sql="INSERT INTO venta (nombre_c,direccion_c,telefono_c,celular_c,nombre_a,cantidad,fecha,vendedor) 
	VALUES ('$_POST[nombre_c2]','$_POST[direccion_c2]','$_POST[telefono_c2]','$_POST[celular_c2]','$_POST[nombre_a2]','$_POST[cantidad2]','$nuevafecha2','$vendedor')";
	$result= mysql_query($sql);
	mysql_close();
	$TipoRegistro2 = '3';
