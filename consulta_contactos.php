...
$filtro_telefono = getParam($_POST["filtro_telefono"], "");
$filtro_celular = getParam($_POST["filtro_celular"], "");
...
Buscar Contactos
<form method="post" action="index.php?p=consulta_contactos">
...
<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
	<thead>
	<tr>
    <th class="asc"><h3>Id</h3></th>
    <th class="asc"><h3>Nombre</h3></th>
	...
	<th class="head"><h3>Ultima vez contactada</h3></th>
  </tr>
   <tr></tr>
   </thead>
   <tbody>
  ...
  <tr>
    ...
    <td class=""><?php echo $result['direccion']; ?></td>
	<td class=""><?php echo $result['telefono']; ?></td>
	<td class=""><?php echo $result['celular']; ?></td>
	<?php
	...
	<td class=""><?php echo $result['ultimo_contacto']; ?></td>
	
    <td><a href="index.php?p=editar_contacto.php&nombre=<?php echo $result['nombre']; ?>">Consultar Perfil</a></td>
  </tr>
  <?php } ?>
  </tbody>
</table>
