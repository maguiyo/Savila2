<?php
	...
	$sql="INSERT INTO ARTICULOS (nombre,precio,descripcion,promocion,activo) VALUES ('$_POST[nombre]','$_POST[precio]','$_POST[descripcion]','0','1')";
		?>
...
.add_insert{width:468px;height:60px;float:left;border:0px solid red;margin-left: 492px;margin-top: -42px;}
	...
	<h4>Se ha creado satisfactoriamente el Art&iacuteculo. </h4>
	<a href="index.php?p=consulta_articulos">Volver a Lista Art&iacuteculos </a></td>
